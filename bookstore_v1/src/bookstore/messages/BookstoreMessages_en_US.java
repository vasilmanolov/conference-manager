...
public class BookstoreMessages_en_US extends ListResourceBundle {
    static final Object[][] contents = {
            ...
            { "BookAdmin", "Books Administrator" },
            { "DeleteBook", "Delete" },
            { "CreateBook", "Add New Book" },
            { "EditBook", "Edit" },
            { "BookDeleteSuccess", "Book With Id Successfully Deleted" },
            { "BookDeleteFail", "Book With Cannot Be Found" },
            { "BackToAdminUi", "Back To Book Admin" },
            ...
            { "Caption", "Books in Shopping Cart" },
            { "TitleApp", "Bookstore"},
            { "AuthorAdministrationTitle", "Administration of authors"},
            { "AuthorAdded", "Author [%s %s] was successfully added."},
            { "AuthorNotAdded", "Author was not successfully added."},
            { "AuthorUpdated", "Author [%s %s] was successfully updated."},
            { "AuthorNotUpdated", "Author [%s %s] was not successfully updated."},
            { "AuthorDeleted", "Author [%s %s] was successfully deleted." },
            { "AuthorNotDeleted", "Author [%s %s] was not successfully deleted." },
            { "UpdateAuthor", "Update"},
            { "CreateAuthor", "Create"},
            { "DeleteAuthor", "Delete"},
            { "HintAddNewAuthor", "To add new author enter first and last name and click button 'Add'"}
        };
